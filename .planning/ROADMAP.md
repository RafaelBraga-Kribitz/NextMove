...
**Plans**: 13 plans (11/11 executed; 2 gap-closure plans pending from 01-UAT.md)

Plans:
**Wave 1**

- [x] 01-01-PLAN.md — Toolchain, ten-package skeleton, test harness (ENG-01, ENG-08)
- [x] 01-02-PLAN.md — ADRs 001–010 ratifying OD-1..OD-10; docs/ relocation (DOC-01)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 01-03-PLAN.md — Layered config, Pydantic validation, stable config hash, seeds (ENG-03, ENG-04)
- [x] 01-04-PLAN.md — Import-linter boundary contracts and Linux-only CI (SIM-02, ENG-01)
- [x] 01-05-PLAN.md — Canonical event schema and inward-only adapter seam (DATA-01)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 01-06-PLAN.md — Storage repository layer, content-hash lineage, DVC (DATA-04, ENG-01, ENG-04, ENG-09)
- [x] 01-07-PLAN.md — Simulator world: per-entity RNG, clock, latent traits, seasonal catalog (SIM-01)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 01-08-PLAN.md — Daily tick, response functions, micro-events, UC1/UC2 occurrence (SIM-01, SIM-04)

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 01-09-PLAN.md — Ingest validation, quarantine, semantic gates, DQ summary (DATA-02, DATA-03)

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 01-10-PLAN.md — Point-in-time feature layer, leakage proofs, time-aware splits (FEAT-01, FEAT-02)
...
**Gap closure** *(from 01-UAT.md; both are wave 1 and independent of each other)*

- [ ] 01-12-PLAN.md — G-01-1: split the `write_table_from_parts` dedupe merge into two materialized stages so default-scale ingest stops OOM'ing under the 512MB DuckDB ceiling (ENG-04, ENG-08)
- [ ] 01-13-PLAN.md — G-01-2: give the peak-RSS assertions their own marker and make the Linux CI gate actually select, run and enforce them (ENG-08)
