...
- [ ] **SIM-04**: The simulator emits micro-conversion (PCR) events — scroll, filter, dwell class —
...
- [ ] **ENG-01**: The repository is a modular monolith with packages `simulator / ingest / features /
...
- [ ] **ENG-08**: The system runs entirely on a laptop — one deployable API container, a
